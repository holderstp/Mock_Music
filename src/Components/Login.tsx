...
const Login = ({
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0  max-h-full flex justify-center items-center bg-opacity-25 bg-black transition ease-in-out delay-10  hover:-translate-y-1 hover:scale-110 duration-200 "
    >
